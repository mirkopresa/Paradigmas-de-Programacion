...
# Respuesta
Se viola el principio OCP (Open/Closed Principle), ya que para agregar una nueva funcionalidad a calcularPrecio, se requiere modificar el codigo
cuando podriamos tener un tipo enumerativo que facilite esto