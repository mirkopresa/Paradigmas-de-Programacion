...
Este ultimo se viola claramente ya que la clase Usuario tiene 2 responsabilidades, almacenar un usuario, y tambien actua como sistema encargado
de guardar usuarios, cambiar contraseñas, etc

La solucion seria separar estas responsabilidades en diferentes clases