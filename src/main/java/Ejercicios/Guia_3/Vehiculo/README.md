...
# Respuesta
El principio que se viola es el ISP (Interface Segregation Principle), ya que la clase bicicleta depende de metodos de la interfaz
Vehiculo que al final, no termina utilizando